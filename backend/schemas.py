...
class SalesReturnCreate(BaseModel):
    ...
    # FASE I — SEBAB keluhan (master `complaint_reasons`, berlapis per badan usaha).
    # Bukan teks bebas: "barang kembali" tanpa sebab tidak bisa dihitung, dan tiga
    # pertanyaan pemilik (supplier mana yang paling sering bermasalah · keluhan mana
    # yang berujung klaim · apakah inspeksi menyetujui keluhan) mustahil dijawab.
    complaint_code: str = ""
    complaint_note: str = ""
