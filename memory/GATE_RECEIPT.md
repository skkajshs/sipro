...
- **Waktu:** 2026-09-02 06:45:52
- **Mode:** `full`  ·  **Durasi total:** 369s  ·  **Pekerja statik:** 2
...
| guard:picker_portal (INV-UI-09, pemilih wajib ber-portal · pop-up bukan anak <label>) | PASS (7s) |
...
| POC FASE G-1 (amandemen ber-alasan) | FAIL (3s) |
...
| POC FASE G-7 (kontrabon · potongan · toleransi config · bayar sekali) | PASS (13s) |
| POC FASE G-6 (antar entitas · dokumen kembar · netting · eliminasi margin) | PASS (9s) |
...
| seed_realistic (pulihkan data demo setelah FASE POC) | PASS (16s) |
